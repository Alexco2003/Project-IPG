...
void Lab10::Init()
{
	...
	LoadShader("Ex4", "WorldSpace", "Ex4", "Ex4");
	LoadShader("Ex5", "WorldSpace", "Ex5", "Ex5");
}
...
{
    {
        ...
        RenderSimpleMesh(meshes["archer"], shaders["Ex4"], modelMatrix, mapTextures["archer"]);
    }
...

    {
        ...
        modelMatrix = glm::translate(modelMatrix, glm::vec3(2, 0, 2));
        modelMatrix = glm::scale(modelMatrix, glm::vec3(0.01));
        RenderSimpleMesh(meshes["archer"], shaders["Ex5"], modelMatrix, mapTextures["archer"]);
    }
