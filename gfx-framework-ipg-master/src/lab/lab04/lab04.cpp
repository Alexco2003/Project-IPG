    ...
    const glm::mat4 &transformation)
{
    ...
    // TODO(student): Ex. 3
	homogenous_coordinate /= homogenous_coordinate.w;
...
void Lab04::DrawTetrahedron()
{
    ...
    vector<VertexFormat> vertices
    {
        VertexFormat(glm::vec3(0.5,  0.5,  0.5), glm::vec3(1, 0, 0)), // 0 - rosu
        VertexFormat(glm::vec3(-0.5, -0.5,  0.5), glm::vec3(0, 1, 0)), // 1 - verde
        VertexFormat(glm::vec3(-0.5,  0.5, -0.5), glm::vec3(0, 0, 1)), // 2 - albastru
        VertexFormat(glm::vec3(0.5, -0.5, -0.5), glm::vec3(1, 1, 0)), // 3 - galben
    };
